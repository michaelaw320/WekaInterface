...
public class WekaInterface {
  ...
  public static String usage() {
    return
        "\nusage:\n  " + WekaInterface.class.getName() 
        + "  CLASSIFIER <classname> [options] \n"
        + "  DATASET <trainingfile>\n\n"
        + "e.g., \n"
        + "  java -jar WekaInterface.jar \n"
        + "    CLASSIFIER weka.classifiers.trees.NBTree OR weka.classifers.tree.Id3 \n"
        + "    DATASET something.arff\n";
  }
  
  /**
   * runs the program, the command line looks like this:<br/>
   * WekaInterface CLASSIFIER classname [options] 
   *          FILTER classname [options] 
   *          DATASET filename 
   * <br/>
   * e.g., <br/>
   *   java -classpath ".:weka.jar" WekaInterface \<br/>
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (args.length < 4) {
      System.out.println(WekaInterface.usage());
      System.exit(1);
    }
